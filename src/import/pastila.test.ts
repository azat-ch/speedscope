...
describe('pastila.nl support', () => {
  describe('isPastilaUrl', () => {
    test('detects pastila.nl URLs', () => {
      ...
      expect(isPastilaUrl('https://pastila.nl/?abc12345/def67890123456789012345678901234.json')).toBe(
        true,
      )
      expect(
        isPastilaUrl(
          'https://pastila.nl/?abc12345/def67890123456789012345678901234#keyBase64GCM',
        ),
      ).toBe(true)
    })
  ...
  describe('parsePastilaUrl', () => {
    ...
    test('rejects invalid URL formats', () => {
      ...
      expect(parsePastilaUrl('https://pastila.nl/?toolong123/def67890123456789012345678901234')).toBeNull()
